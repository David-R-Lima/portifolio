    ...
    return (
        <div className="flex flex-col items-center max-w-[90vw] space-y-10 mb-20 mt-20">
            ...
            <div className="self-start mb-20 space-y-4 max-w-[90vw] ">
                <h1 className="text-secondary w-[90vw] bg-primary/20 p-4 rounded-lg text-lg font-bold">Technologies </h1>
            ...
            <div className="space-y-4 self-start ">
                <h1 className="text-secondary w-[90vw] bg-primary/20 p-4 rounded-lg text-lg font-bold">Work experience</h1>
                <div className="p-4 bg-primary/10 rounded-md text-secondary">
